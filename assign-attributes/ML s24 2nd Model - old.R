...
# Train the model
rf.fit41 <- train(DIAMETE ~ n2_D + n2_M + n2_Y + PURPOSE + County + PROPERTY_TYPE + Year,
                  tuneLength = 1,
...
rf.fit41_County <- read_rds("G:/Desktop/STW PDaS/Git/pdas_mapping/assign-attributes/S24diam_model County.RDS")

rf.preds24 <- predict(rf.fit41_County, newdata = testdata.base2)
