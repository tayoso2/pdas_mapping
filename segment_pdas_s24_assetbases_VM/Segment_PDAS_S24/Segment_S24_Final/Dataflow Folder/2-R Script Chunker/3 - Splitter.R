...
if (dataflow == TRUE) {
  ...
  fold_in_source <- file.path("C:/Users/TOsosanya/Downloads/Segment Dataflow_nh_fix/Dataflow Folder/3-R Script Source")
...
# IMPORTANT: upper threshold for pdas, change for s24
upper_thres <- 27.9
# rules
# 5.5,17.5 pdas
# 9.9,27.9 s24
...
rbind(something2,new_pipe_3_0_upper_thres) %>%
  ...
  st_write(paste0(fold_out_pipes,"/merged_linestrings_s24.shp"))
